...
<s:if test="result.rlSensePrl != null">
...
<tr><td width='180'>Resource</td><td nowrap>P(r|l)</td></tr>

<s:iterator value="result.rlSensePrl">  
...
<s:if test="result.rlCoOccurrencePrl != null">
...
<s:iterator value="result.rlCoOccurrencePrl"> 
<s:if test="%{outlang == 'en' || outlang == 'de' || outlang == 'es'}">
    <tr><td width='180'><small><s:a href="%{key.url}" target="_Blank"><s:property value="key.title"/></s:a></small></td><td nowrap><small><s:property value="value"/></small></td></tr>
</s:if>
<s:else>
...
<s:if test="compResult.rlComparePrl == null && compResult.rlComparePmi == null">
<td valign='top'><div style='background-color:#BDBDBD; padding:5px; '>
DBpedia NLP Datasets: Association with Label <b><s:property value="searcher" /></b>:
<p><table cellspacing='1' cellpadding='5' border='1' width='250' style='margin:10px; '>
...
<s:if test="compResult.rlComparePrl != null">
...
<s:iterator value="compResult.rlComparePrl"> 
<s:if test="%{outlang == 'en' || outlang == 'de' || outlang == 'es'}">
    <tr><td width='180'><small><s:a href="%{key.url}" target="_Blank"><s:property value="key.title"/></s:a></small></td><td nowrap><small><s:property value="value"/></small></td></tr>
</s:if>
<s:else>
